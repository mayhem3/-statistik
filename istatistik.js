...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    ...
    .addField("<a:crank:778975399464009739> **|** **Çalışma süresi**", unutulmuşzaman, true).addField("<:utandm:777095995690450944> **|** **Kullanıcılar**",client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString(), true)
